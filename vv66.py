# -*- coding: utf-8 -*-
# VERSION V4.0 - Complet : Fix OT_COR_EGAL + Nouvelle page Variance avec Historisation KPI_Historique.xlsx
...
st.set_page_config(layout="wide", page_title="Dashboard KPI V4")
