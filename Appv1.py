...
# [EVOL] Graissage, Inspection, Systématiques déplacés vers Performance
...
def inject_custom_css():
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .synth-tbl .sec-header td{background:#2c5282!important;color:#fff!important;font-weight:800;font-size:13px;padding:8px}
...
def main():
    ...
    def get_division(p):
        ...
        return "Autre"
    # [EVOL] Trouver la colonne désignation/texte
    def get_text_col(df):
        ...
        for c in df.columns:
            if df[c].dtype=='object' and any(kw in str(c).lower() for kw in ['sign','text','desc','libell']):
                return c
        return None
    # [EVOL] Construire pivot Statut OT par poste
    ...
    # [EVOL] HTML table pour pivot Statut OT
    def html_statut_pivot(piv_df, table_class):
        ...
        h+='</tr></tbody></table>'
        return h
    # [EVOL] Afficher 2 pie charts côte à côte
    ...
    # [EVOL] HTML tableau résumé anomalies KPI x Poste
