...
def main():
    ...
    def calc_kpis(df_i,av_i,now,posts):
        ...
        for c in ["APRQ","APRV","APRV AVAU","REJT"]: tca[c] = tca[c] if c in tca.columns else 0; tca["Total"]=tca[["APRQ","APRV","APRV AVAU","REJT"]].sum(axis=1); tca["appel avis approuvé"]=ckpi(tca["APRV"],tca["Total"])
