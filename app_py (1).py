...
# ==================================================
def main():
    # Force la locale en français pour que le calendrier de Streamlit s'affiche en français
    try:
...
if __name__ == "__main__":
    # Force la langue française pour le calendrier natif du navigateur via Streamlit
    try:
        locale.setlocale(locale.LC_ALL, 'fr_FR.UTF-8')
    except:
        try:
