...
if not use_new_files or (ot_file is not None and avis_file is not None):
    try:
        ...
        # MODIFICATION DATE PAR DEFAUT : 01/01/2025 au lieu du min du fichier
        ...
        if type_tableau == "Tableau de bord des KPIs":
            ...
            if not df_anomalies_ot.empty:
                ...
                # MODIFICATION ICI : Masquer la colonne Poste si "All" est sélectionné
                if "All" in selected_postes:
            ...
            st.markdown("---")
            st.subheader("Classement des Postes de Travail par Qualité des Kpi")
        ...
        if postes_avec_anomalies:
            # MODIFICATION ICI : Ajout de "All" dans les options d'export
            options_export = ["All"] + postes_avec_anomalies
            selected_poste_export = st.selectbox("Sélectionnez le poste de travail pour générer le fichier Excel :", options=options_export)
            ...
            if st.button("📥 Générer et télécharger le fichier Excel", type="primary"):
                with st.spinner("Génération du fichier en cours..."):
                    ...
                    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
                        if selected_poste_export == "All":
                            # Si "All" est choisi, on boucle sur tous les postes ayant des anomalies
                            postes_a_traiter = postes_avec_anomalies
                        else:
                            postes_a_traiter = [selected_poste_export]
                            ...
                            for kpi in kpis_en_defaut:
                                ...
                                if kpi != "appel avis approuvé":
                                    ...
                                    if not subset_ot.empty:
                                        ...
                                        subset_ot["Poste de travail principal"] = poste_export # Ajout du poste pour fichier All
                                ...
                                if kpi == "appel avis approuvé":
                                    ...
                                    if not subset_avis.empty:
                                        ...
                                        subset_avis["Poste de travail principal"] = poste_export # Ajout du poste pour fichier All
                                ...
                                if not sheet_data.empty:
                                    if selected_poste_export == "All":
                                        sheet_name = "Tous_les_postes" # Nom de l'onglet unique si "All"
                                    else:
                    ...
                    st.download_button(
                        ...
                        file_name=f"Plan_Action_Global.xlsx" if selected_poste_export == "All" else f"Plan_Action_{selected_poste_export.replace(' ', '_')}.xlsx",
