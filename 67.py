        ...
        try:
            ...
            with tabs[1]:
                ...
                if ano_p_rows:
                    ...
                    st.markdown(html_ano(ano_p_rows,["Poste travail princ.","Indicateurs","Nb anomalies"]),unsafe_allow_html=True)
            ...
            with tabs[2]:
                ...
                if ano_q_rows:
                    ...
                    st.markdown(html_ano(ano_q_rows,["Poste travail princ.","Indicateurs","Nb anomalies"]),unsafe_allow_html=True)
